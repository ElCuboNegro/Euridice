...
clean:
	rm -rf build dist docs/build Euridice/html pip-wheel-metadata .mypy_cache .pytest_cache features/steps/test_plugin/test_plugin.egg-info
...
lint:
	...
	mypy euridice --strict --allow-any-generics --no-warn-unused-ignores
test:
...
linkcheck:
	uv pip install --system "euridice[docs] @ ."
...
install-test-requirements:
	...
	uv pip install --system "euridice[test] @ ."
