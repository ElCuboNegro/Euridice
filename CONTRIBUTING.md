...
Welcome to `Euridice` contributor's guide.
...
If you experience bugs or general issues with `Euridice`, please have a look
...
You can help improve `Euridice` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`Euridice` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `Euridice`'s files. While this mechanism can
...
```
conda create -n Euridice python=3 six virtualenv pytest pytest-cov
conda activate Euridice
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/Euridice.git
   cd Euridice
   ```
...
5. Install [pre-commit]:
   ...
   `Euridice` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/Euridice
[issue tracker]: https://github.com/<USERNAME>/Euridice/issues
